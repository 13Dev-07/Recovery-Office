...
var ContactExample = function () {
    ...
    return (<Box_1.Box>
      ...
      <Box_1.Box mb={10}>
        <feature_sections_1.Contact title="Get in Touch" subtitle="Reach out to us with any questions about our holistic services" layout="split" animated={true} botanical={{
            type: 'flowerOfLife',
            position: 'topRight',
            opacity: 0.05,
            size: 'xl'
      ...
      <Box_1.Box mb={10} backgroundColor="#f8f9fa" py={8}>
        <feature_sections_1.Contact title="Schedule a Consultation" subtitle="Take the first step on your recovery journey" layout="stacked" formFields={customFormFields} submitText="Request Appointment" backgroundColor="transparent" animated={true} botanical={{
            type: 'vesicaPiscis',
            position: 'bottomLeft',
            opacity: 0.07,
            size: 'lg'
      ...
      <Box_1.Box mb={10}>
        <feature_sections_1.Contact title="Support & Resources" subtitle="We're here to support your wellness journey" layout="split" contactOptions={customContactOptions} formAction="/api/contact" submitText="Send Request" animated={true} botanical={{
            type: 'oliveBranch',
...
exports.default = ContactExample;
