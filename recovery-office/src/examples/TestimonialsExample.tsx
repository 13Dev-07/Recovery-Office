...
import { Testimonials } from '../design-system/components/feature-sections';
    ...
    <Box>
      ...
      <Box mb={10}>
        <Testimonials
          ...
          subtitle="Experiences from those who have embraced our sacred geometry approach"
      ...
      <Box mb={10} backgroundColor="#f8f9fa" py={8}>
        <Testimonials
          ...
          subtitle="Swipe through stories of transformation and healing"
          testimonials={testimonials}
      ...
      <Box mb={10}>
        <Testimonials
          ...
          subtitle="Highlighted experiences from our recovery community"
          testimonials={testimonials.slice(0, 3)} // First three testimonials
