...
var HeroExample = function () {
    return (<div>
      ...
      <feature_sections_1.Hero heading="Discover Holistic Healing" subheading="Recovery Office provides therapeutic solutions guided by sacred geometry and natural harmony" background={{
        ...
        <Text_1.Text variant="body1" style={{ maxWidth: '600px', margin: '0 auto', color: 'white' }}>
      ...
      <Box_1.Box mt={8} mb={8}>
        <feature_sections_1.Hero heading="Our Sacred Approach" subheading="Healing guided by golden ratio principles" background={{
            color: '#f8f9fa'
        }} minHeight="70vh" split={true} align="left" botanical={{
            type: 'oliveBranch',
            position: 'topLeft',
            opacity: 0.1
        }} buttons={[
        ...
        ]} secondaryContent={<AspectRatio_1.AspectRatio ratio={1} style={{ boxShadow: '0 4px 20px rgba(0,0,0,0.1)', borderRadius: '8px', overflow: 'hidden' }}>
              <img src="https://images.unsplash.com/photo-1584814044760-6cfa339c12c3?auto=format&fit=crop&w=800&q=80" alt="Holistic healing session" style={{ width: '100%', height: '100%', objectFit: 'cover' }}/>
            </AspectRatio_1.AspectRatio>}>
          <Text_1.Text variant="body1" style={{ opacity: 0.8 }}>
          ...
          <Box_1.Box mt={4} display="flex" alignItems="center">
            <botanical_1.OliveBranch width={24} height={24} opacity={0.7} style={{ marginRight: '8px' }}/>
            <Text_1.Text variant="subtitle2">Harmony in every aspect of recovery</Text_1.Text>
          </Box_1.Box>
        </feature_sections_1.Hero>
      </Box_1.Box>

      {/* Minimal Hero with gradient background */}
      <feature_sections_1.Hero heading="Ready to Begin Your Journey?" background={{
            color: 'linear-gradient(135deg, #4a6eb3 0%, #2a4073 100%)'
        }} minHeight="50vh" align="center" animated={true} buttons={[
            {
                label: 'Schedule Now',
                variant: 'accent',
                href: '/contact',
        ...
        <Text_1.Text variant="body2" style={{ color: 'rgba(255,255,255,0.8)', maxWidth: '500px', margin: '0 auto' }}>
      ...
      <Box_1.Box mt={8}>
        <feature_sections_1.Hero heading="Therapeutic Education" subheading="Learn sacred geometry principles for self-healing" background={{
            color: '#f0f4f8'
        }} minHeight="60vh" align="right" split={true} reverseSplit={true} botanical={{
            type: 'vesicaPiscis',
            position: 'bottomLeft',
            size: 'xl',
            opacity: 0.08
        ...
        ]} secondaryContent={<Box_1.Box display="flex" alignItems="center" justifyContent="center" height="100%">
              <botanical_1.FlowerOfLife size="xl" strokeWidth={0.5} primaryColor="#2a4073" secondaryColor="rgba(0,0,0,0)" opacity={0.8}/>
            </Box_1.Box>}>
          <Text_1.Text variant="body1" style={{ opacity: 0.8 }}>
