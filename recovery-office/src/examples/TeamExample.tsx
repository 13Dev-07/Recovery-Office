...
import { Team } from '../design-system/components/feature-sections';
...
const TeamExample: React.FC = () => {
  ...
  return (
    <Box>
      ...
      <Box mb={10}>
        <Team
          title="Our Therapeutic Team"
          subtitle="Meet the professionals dedicated to your holistic recovery journey"
          members={teamMembers}
          displayStyle="grid"
          columns={3}
      ...
      <Box mb={10} backgroundColor="#f8f9fa" py={8}>
        <Team
          title="Lead Practitioners"
          subtitle="Our specialists combine ancient wisdom with modern therapeutic techniques"
          members={teamMembers.slice(0, 3)} // First three team members
          displayStyle="list"
      ...
      <Box mb={10}>
        <Team
          ...
          subtitle="Guiding our practice with expertise and vision"
          members={teamMembers.slice(0, 3)} // First three team members for featured layout
