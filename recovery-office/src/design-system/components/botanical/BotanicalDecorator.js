 ...
 */
var BotanicalDecorator = React.forwardRef(function (_a, ref) {
    ...
    return (<Container className={className} style={style} data-testid={testId} $animateOnHover={animateOnHover} $showOnMobile={showOnMobile} ref={ref}>
        {children}
