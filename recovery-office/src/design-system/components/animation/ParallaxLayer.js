...
var getFibonacciByIndex = function (index) {
    var _a;
    var fibKeys = Object.keys(FIBONACCI).map(Number).sort(function (a, b) { return a - b; });
    var safeIndex = Math.max(0, Math.min(index, fibKeys.length - 1));
    return FIBONACCI[(_a = fibKeys[safeIndex]) !== null && _a !== void 0 ? _a : 1];
};
/**
 ...
 */
exports.ParallaxLayer = React.forwardRef(function (_a, ref) {
    ...
    var _h = (0, react_1.useState)(0), elementTop = _h[0], setElementTop = _h[1];
    var _j = (0, react_1.useState)(0), viewportHeight = _j[0], setViewportHeight = _j[1];
    var _k = (0, react_1.useState)(0), elementHeight = _k[0], setElementHeight = _k[1];
    ...
    var effectiveRange = range || getFibonacciByIndex(9); // 34px (9th Fibonacci number)
    ...
    (0, react_1.useEffect)(function () {
        if (!elementRef.current || !isEffectivelyEnabled)
            return;
    ...
    var combinedRef = (0, refs_1.mergeRefs)([elementRef, ref]);
