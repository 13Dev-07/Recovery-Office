...
var SocialLinksContainer = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n  display: flex;\n  gap: ", "px;\n  justify-content: center;\n  margin-bottom: ", "px;\n"], ["\n  display: flex;\n  gap: ", "px;\n  justify-content: center;\n  margin-bottom: ", "px;\n"])), getFibonacciByIndex(4), getFibonacciByIndex(5));
// Individual social link
var SocialLink = styled_components_1.default.a(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: ", "px;\n  height: ", "px;\n    border-radius: 50%;\n    background-color: rgba(255, 255, 255, 0.1);\n  color: ", ";\n  transition: transform 0.2s, background-color 0.2s;\n                \n    &:hover {\n      background-color: rgba(255, 255, 255, 0.2);\n      transform: scale(", ");\n  }\n"], ["\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  width: ", "px;\n  height: ", "px;\n    border-radius: 50%;\n    background-color: rgba(255, 255, 255, 0.1);\n  color: ", ";\n  transition: transform 0.2s, background-color 0.2s;\n                \n    &:hover {\n      background-color: rgba(255, 255, 255, 0.2);\n      transform: scale(", ");\n  }\n"])), getFibonacciByIndex(6), getFibonacciByIndex(6), function (props) { return props.theme.colors.white; }, PHI_INVERSE * PHI);
/**
...
var FooterSocial = function (_a) {
    ...
    return (<SocialLinksContainer className={className}>
        {links.map(function (link, index) { return (<SocialLink key={"".concat(link.platform, "-").concat(index)} href={link.url} target="_blank" rel="noopener noreferrer" aria-label={"Follow us on ".concat(link.platform)}>
