...
export const premiumTheme: RecoveryOfficeTheme = {
  colors: {
    primary: PREMIUM_COLORS.BASE_COLORS.navy,
    secondary: PREMIUM_COLORS.BASE_COLORS.steelBlue,
    background: {
      ...
      800: PREMIUM_COLORS.BASE_COLORS.navy[800],
      900: PREMIUM_COLORS.BASE_COLORS.navy[900],
      950: PREMIUM_COLORS.BASE_COLORS.navy[950],
    ...
    accent: {
      ...
      teal: PREMIUM_COLORS.BASE_COLORS.steelBlue[500],
      lavender: '#A992E2',
      rose: '#E27992'
    },
    success: {
    ...
    feedback: {
      ...
      info: {
        light: PREMIUM_COLORS.BASE_COLORS.steelBlue[300],
        main: PREMIUM_COLORS.BASE_COLORS.steelBlue[500],
        dark: PREMIUM_COLORS.BASE_COLORS.steelBlue[700]
      }
    },
    gradients: {
      primary: `linear-gradient(45deg, ${PREMIUM_COLORS.BASE_COLORS.navy[600]} 0%, ${PREMIUM_COLORS.BASE_COLORS.navy[500]} 100%)`,
      secondary: `linear-gradient(45deg, ${PREMIUM_COLORS.BASE_COLORS.steelBlue[600]} 0%, ${PREMIUM_COLORS.BASE_COLORS.steelBlue[400]} 100%)`,
