...
exports.ScrollReveal = React.forwardRef(function (_a, ref) {
    ...
    resetOnExit = _h === void 0 ? false : _h, _j = _a.rootMargin, rootMargin = _j === void 0 ? "0px" : _j, _k = _a.initialScale, initialScale = _k === void 0 ? sacred_geometry_1.PHI_INVERSE : _k, _l = _a.useGoldenRatio, useGoldenRatio = _l === void 0 ? true : _l, as = _a.as, rest = __rest(_a, ["children", "variant", "duration", "delay", "easing", "threshold", "distance", "resetOnExit", "rootMargin", "initialScale", "useGoldenRatio", "as"]);
    ...
    var _m = (0, react_intersection_observer_1.useInView)({
        threshold: threshold,
        rootMargin: rootMargin,
        triggerOnce: !resetOnExit,
    }), inViewRef = _m.ref, inView = _m.inView;
    // Combine refs
    ...
    return (<framer_motion_1.motion.div ref={combinedRef} initial="hidden" animate={controls} variants={getVariants()} style={{ willChange: 'transform, opacity' }} // Add performance optimization
     {...rest}>
        {children}
