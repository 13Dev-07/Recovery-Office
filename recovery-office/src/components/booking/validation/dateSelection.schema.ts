import { z } from 'zod';
import { PHI, FIBONACCI, ANIMATION_TIMING } from '../../../constants/sacred-geometry';
 ...
 */
export const validateField = (field: keyof DateSelectionData, value: any): string | null => {
  try {
    // Create a test object with all default values
    const testObject = { ...dateSelectionDefaultValues } as any;
